...
<title><?php echo $title;?> | BKK Khoirul Mustofa</title>
...
<!--[if lt IE 9]>
  ...
  <![endif]-->
  <?php include "administrator_css.php"; ?>
</head>
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<!-- jQuery 2.2.0 -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>plugins/jQuery/jQuery-2.2.0.min.js"></script>
	<!-- Bootstrap 3.3.6 -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>bootstrap/js/bootstrap.min.js"></script>
	<!-- SlimScroll -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>plugins/slimScroll/jquery.slimscroll.min.js"></script>
	<!-- FastClick -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>plugins/fastclick/fastclick.js"></script>
	<!-- AdminLTE App -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>dist/js/app.min.js"></script>
	<!-- AdminLTE for demo purposes -->
	<script
		src="<?php echo base_url('template/admin_lte/'); ?>dist/js/demo.js"></script>
		
		<?php include "administrator_js.php"; ?>
</body>
</html>
